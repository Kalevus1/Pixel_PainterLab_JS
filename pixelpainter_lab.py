# -*- coding: utf-8 -*-
"""
Día 9 - PixelPainter Lab  ·  PySide6
------------------------------------
Convierte una imagen en una GUÍA PARA PINTAR POR NÚMEROS:
  · Elige la resolución (celdas) y el número de colores (pinturas).
  · Cuantiza los colores con K-means (agrupa tonos parecidos).
  · Cuadrícula numerada + leyenda de la paleta + receta de mezcla de cada color.
  · Resalta todas las celdas de un color y exporta una guía imprimible.

Versión de escritorio del sistema web. Todo local, sin internet.
Ejecuta con "PixelPainter.bat".
